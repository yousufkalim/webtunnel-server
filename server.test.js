...
describe('Server', () => {
  ...
  it('should redirect root requests to landing page', async () => {
    ...
    assert.equal('https://webtunnel.github.io/www/', res.headers.location);
  });
  ...
  it('should upgrade websocket requests', async () => {
    ...
    const webtunnelPort = res.body.port;
    ...
    const ltSocket = net.createConnection({ port: webtunnelPort });
