...
class Client extends EventEmitter {
  constructor(options) {
    ...
    this.debug = Debug(`wt:Client[${this.id}]`);
    ...
    // TODO(yousuf): an agent error removes the client, the user needs to re-connect?
  ...
  handleRequest(req, res) {
    ...
    clientReq.once('error', (err) => {
      // TODO(yousuf): if headers not sent - respond with gateway unavailable
    });
